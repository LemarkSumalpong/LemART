    ...
    },
    {
        ...
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M18 3C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6C3 4.34315 4.34315 3 6 3H18ZM18 4.5H6C5.17157 4.5 4.5 5.17157 4.5 6V18C4.5 18.8284 5.17157 19.5 6 19.5H12V13.5H9.75V10.5H12V8.25C12 6.59315 13.3431 5.25 15 5.25H17.25V8.25H15C14.5858 8.25 14.25 8.58579 14.25 9V10.5H17.25V13.5H14.25V19.5H18C18.8284 19.5 19.5 18.8284 19.5 18V6C19.5 5.17157 18.8284 4.5 18 4.5Z"
             fill="currentColor" />
          </svg>
        ),
        alt: 'Facebook'
                    ...
                    {socialLinks.map(({href, icon}, key) =>(
                        <a
                         ...
                         className="w-12 h-12 grid place-items-center ring-inset ring-2
                          ring-zinc-50/50 rounded-lg transition[background-color,color]
